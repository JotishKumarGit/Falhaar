...
const About = () => {
  ...
  return (
    <section className="py-5 " style={{background: 'linear-gradient(45deg, #2c2c21ff, #a1ecd6ff)' }}>
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 text-center text-lg-start py-2 animate__animated animate__fadeInLeft">
            ...
            <ul className=' text-start'>
              <li className='list-unstyled text-white' ><TiChevronRight />We Are Supplier</li>
              <li className='list-unstyled text-white'><TiChevronRight />We Are Supplier</li>
            </ul>
            <div>
